...
- A consumer **MUST NOT** pass secrets in the request and **SHOULD** start the command with the environment of the editor session, not with extra credentials. <a id="S2-6-2"></a><a id="S2-6-3"></a><sup>S2-6-2, S2-6-3</sup>
