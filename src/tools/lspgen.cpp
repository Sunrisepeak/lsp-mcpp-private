// lsp-mcpp-lspgen: generates lspmcpp.lsp.protocol from the LSP meta model.
//
//   lsp-mcpp-lspgen generate --meta-model <metaModel.json> --out <dir>
//   lsp-mcpp-lspgen version
import std;
...
int generate(const std::string& metaModelPath, const std::string& outDirectory) {
    ...
    std::string header { std::format("// Generated by lsp-mcpp-lspgen from the Language Server Protocol meta model {}.\n"
                                     "// Do not edit: run `lsp-mcpp-lspgen generate` instead (tools/lspgen/README.md).\n", version) };
    interface += header;
    interface += "export module lspmcpp.lsp.protocol;\n\nimport std;\n\n";
    interface += "export namespace lspmcpp::lsp {\n\n";
    ...
    interface += "} // namespace lspmcpp::lsp\n\n";

    interface += "export namespace lspmcpp::lsp::method {\n\n";
    ...
    implementation += "module lspmcpp.lsp.protocol;\n\nimport std;\n\nnamespace lspmcpp::lsp {\n\nnamespace {\n\n";
    ...
    for (const auto& [file, content] : { std::pair { std::string { "protocol.cppm" }, &interface },
        ...
        const std::string path { lspmcpp::base::join_path(outDirectory, file) };
